...
def read_user_data(self, weight=0, height=0, gender="", age=0, BMR2=0, BMR1=0):
    class Inputs:
        ...
        def get_gender(self):
            while True:
                ...
                if gender.lower() == 'male':
                    BMR1 = (10 * self.weight) + (6.25 * self.height) - (5 * self.age) + 5
                    break
                elif gender.lower() == 'female':
                    BMR1 = (10 * self.weight) + (6.25 * self.height) - (5 * self.age) - 161
                    break
                else:
                    print("Please, enter correct values!")

        def get_activity(self, BMR1=None):
            while True:
...
class Operations:
    ...
    def find_food(self, text, client, calories_limit, cal=0):
        ...
        for nutrient in report.nutrients:
            if nutrient.name == "Energy":
                ...
                assert isinstance(nutrient.value)
                cal += nutrient.value
                if (calories_limit - cal) > 0:
                    print("You have %i calories left" % (calories_limit - cal))
                else:
                    print("You have passed your daily limit by %i" % (cal - calories_limit))
                break
        return cal
...
def find_food(daily_calories, text, client, calories_limit):
    pass
...
def main():
    ...
    while True:
        ...
        if text == "exit":
            ...
            continue
        try:
            find_food(daily_calories, text, client, calories_limit)
        except ValueError:
